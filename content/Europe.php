...
<body onload="gary()">
  ...
  <section class="about" id="about">
    ...
    <div class="jsmaps-wrapper" id="europe-map"></div>
    <!-- End Map html -->
  </div>
  ...
  <script src="../content/lib/lockfixed/lockfixed.min.js"></script>
    ...
    <link href="../content/europe/europe/jsmaps/jsmaps.css" rel="stylesheet" type="text/css" />
  <script src="../content/europe/europe/jsmaps/jsmaps-libs.js" type="text/javascript"></script>
  <script src="../content/europe/europe/jsmaps/jsmaps.js" type="text/javascript"></script>
  <script src="../content/europe/europe/maps/europe.js" type="text/javascript"></script>
